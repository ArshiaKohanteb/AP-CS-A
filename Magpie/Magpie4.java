...
public class Magpie4
{
 ...
 public String getResponse(String statement)
 {
  ...
  else if (findKeyword(statement,"school") >= 0 || findKeyword(statement,"college") >= 0) 
  {
  //Max Holschneider
  response = "Tell me more about your School.";
  } 
  else if (findKeyword(statement,"joke") >= 0 || findKeyword(statement,"laugh") >= 0) 
  {
  //Arshia Kohanteb
  response = "Did you hear about the mathematician whoÕs afraid of negative numbers? \nHeÕll stop at nothing to avoid them.";
  } 
  else if (findKeyword(statement,"real") >= 0 || findKeyword(statement,"human") >= 0 || findKeyword(statement,"bot") >= 0) 
  {
  //Arshia Kohanteb
  response = "if(f(x) == y) \n{\nI'm a bot\n}";
  } 
  else if (findKeyword(statement,"Ms. Murakami") >= 0) 
  {
    //Max Holschneider
