...
public class StartPanel extends JPanel
{
 ...
 public StartPanel(CelebrityGame controller)
 {
  ...
  sportRadio = new JRadioButton("Sport Celebrity");
  sportName = "Your celebrity type clue format hint";
...
//    	//like what are the parameters???
    	//also it refrences a literature else if() but I dont see one
//    }
    else
    {
     invalidInput();
